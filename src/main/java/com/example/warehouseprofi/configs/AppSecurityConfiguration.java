                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests
                                        ...
                                        .requestMatchers("/items/add", "/items/item-delete/", "/users/add", "/users/user-delete/", "/warehouses/add", "/warehouses/warehouse-delete/").hasRole(Role.ADMIN.name())
